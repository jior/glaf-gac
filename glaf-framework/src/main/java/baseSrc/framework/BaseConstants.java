...
public class BaseConstants {
	...
	public static final String ISC_BASE_BEANCOM_MENU = "htmlMenus";
	...
	/** end 共通下拉框 **/
	// confirm标志
	public static final String ISC_COMFIRM_FLAG="comfirmFlag";
	
	public static final String ISC_EXCEL_DOWN_NAME="MyExcel.xls";
