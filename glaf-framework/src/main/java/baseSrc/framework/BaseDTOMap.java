...
public class BaseDTOMap extends HashMap<String, Object> {
    ...
    //Alert消息ID
    private String msgAlertId = null;
    //confirm消息ID
    private String msgConfirmId = null;
    //消息类型
    ...
    //EXCEL报表名称
    private String reportExcelName = "";
    //报表模版
	...
	public void setReportQuery(String queryName,String queryString) {
		...
		if (null==reportQuerys){
			reportQuerys=new HashMap<String, String>();
		}
		if(!BaseUtility.isStringNull(queryName)){
	...
	public void setMsgAlertId(String msgAlertId) {
		this.msgId = msgAlertId;
		this.msgFlag = "";
	}

	public void setMsgConfirmId(String msgConfirmId) {
		this.msgId = msgConfirmId;
		this.msgFlag = BaseConstants.ISC_COMFIRM_FLAG;
	}
	...
	public String getReportExcelName() {
		return reportExcelName;
	}

	public void setReportExcelName(String reportExcelName) {
