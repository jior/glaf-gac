...
public class ZipCipherUtil {   
    ...
    public static void main(String[] args) throws Exception {   
        ...
        //加密   
       // ZipCipherUtil.encryptZip("E:"+File.separator+"alarm"+File.separator+"的说法大法师地方.txt", "E:"+File.separator+"alarm"+File.separator+"的说法大法师地方.zip", "12345"); 
        //解密   
        ZipCipherUtil.decryptUnzip("E:"+File.separator+"alarm"+File.separator+"的说法大法师地方.zip", "E:"+File.separator+"alarm"+File.separator+"", "12345");   
