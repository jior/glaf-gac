...
public class TPrivilege implements java.io.Serializable {
	...
	private String FPrivilegefather;
	...
	public String getFPrivilegefather() {
		return FPrivilegefather;
	}

	public void setFPrivilegefather(String fPrivilegefather) {
		FPrivilegefather = fPrivilegefather;
	}
