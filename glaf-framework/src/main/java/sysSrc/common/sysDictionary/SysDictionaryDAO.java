...
public class SysDictionaryDAO extends BaseDAO {
	private static LogHelper logger = new LogHelper(SysDictionaryDAO.class);
	...
	public SysBaseDTOMap runPageDelete(SysDictionaryFrom form, SysBaseCom baseCom) throws Exception {
	...
	private List<?> getDataFormDB(SysDictionaryFrom form, SysBaseCom baseCom) {
		...
		//取得每一页的显示条数
		int pageSize = form.getPageCounts();
