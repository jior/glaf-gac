...
public class SysDictionaryAddDAO extends BaseDAO {
	...
	public SysBaseDTOMap runPageLoad(SysDictionaryAddFrom form, SysBaseCom baseCom) {
	...
	public SysBaseDTOMap runPageSave(SysDictionaryAddFrom form, SysBaseCom baseCom) {
	 ...
	 */
	private boolean checkInput(SysBaseDTOMap dtoMap,String bigType,String smallType,String con){
		boolean ret = true;
		String errors = "";
