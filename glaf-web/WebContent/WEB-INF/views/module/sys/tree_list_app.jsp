...
<body>
<div class="nav-title"><span class="Title">部门管理（HR）</div>
<html:form action="/sys/department.do?method=addHRDeptToDept" method="post" target="_self"> 
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="50%"> <input name="btn_add" type="submit" value="增加" class="button"> 
