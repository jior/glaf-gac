...
否</td>
      ...
      <tr>
        ...
        <td>
          <input name="headship" type="text" size="30" class="input" datatype="string" nullable="no" maxsize="20" chname="职务" >
          <!-- onClick="selectData('ZD0019', null, this, document.all.userType)" -->
