...
public class SysRoleServiceImpl implements SysRoleService {
	...
	public boolean delete(SysRole bean) {
		abstractDao
				.executeSQL(" delete from sys_user_role where roleid in ( select id from sys_dept_role where sysRoleId = "
						+ bean.getId() + ") ");
		abstractDao
				.executeSQL(" delete from sys_access where roleid in ( select id from sys_dept_role where sysRoleId = "
						+ bean.getId() + ") ");
		abstractDao.executeSQL(" delete from sys_dept_role where sysRoleId="
				+ bean.getId());
